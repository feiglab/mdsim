...
class ClusterFrameResult:
    frame_index: int
    clusters: list[list[int]]  # list of protein-index lists
    edges: list[tuple[int, int]]  # protein pairs considered "in contact"
    contact_counts: dict[tuple[int, int], int]  # raw heavy-atom pair counts for edges
